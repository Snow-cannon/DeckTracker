...
T.test(selectTest1.query === 'SELECT * FROM Decks WHERE did=$1 AND deckname=$2 AND email=$3;',
...
T.test(insertTest1.query === 'INSERT INTO Decks (did, deckname, email) VALUES ($1, $2, $3) RETURNING *;',
...
T.test(updateTest1.query === 'UPDATE Decks SET did=$1, deckname=$2, email=$3 RETURNING *;',
...
T.test(deleteTest1.query === 'DELETE FROM Decks WHERE did=$1 AND deckname=$2 AND email=$3 RETURNING *;',
